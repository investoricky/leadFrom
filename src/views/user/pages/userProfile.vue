    ...
    <div class="main">
        ...
        <div class="userProfile d-md-flex d-sm-block justify-content-between">
            <div class="sideMenuWrap">
                ...
                <ul class="px-5 mb-0">
                    <li class="logOutOption"><i class="fa fa-sign-out text-muted" aria-hidden="true"></i> <router-link to="/" class="text-muted logOutLink">Log Out</router-link></li>
                </ul>
            </div>
            <div class="userDetailSection">
                ...
                <div class="userInfo mt-2 py-4">
                    <div class="d-flex detailText  px-5 py-2">
                        ...
                        <p class="nameBorder py-2 text-muted">John</p>
                    </div>
                    <div class="d-flex detailText px-5 py-2">
...
.dropdown-content a:hover {color: #007e33}
...
.detailText, .firstName, .nameBorder {
    padding: 10px !important;
}
}
.dropdown-content {
